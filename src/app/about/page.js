      ...
      <div className="p-8 min-h-screen">
        ...
        <SectionWrapper>
          ...
          <ul className="list-disc list-inside text-white-600 mb-4">
            <li>
              <strong>Lobby (Home Page):</strong> Stay updated with the latest posts from gamers you follow
              and discover new content from the community.
            </li>
            <li>
        ...
        <SectionWrapper>
          ...
          <p className="text-white-600 mb-4">
            ...
            platform is built by gamers, for gamers, with the aim of fostering a community where everyone can
            share their love for games. Whether you&apos;re a casual player or a hardcore gamer, GameGrid is
            the place for you to connect, compete, and grow. Join us on this exciting journey and be a part of
            the GameGrid community!
          </p>
        </SectionWrapper>
      </div>
    </>
